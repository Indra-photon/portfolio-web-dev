...
const About = () => {
  ...
  return (
    <div className="bg-amber-200 min-h-screen">
      <Navbar />
      <div className="container mx-auto py-12 px-6 lg:px-48">
        ...
        <section className="flex flex-col lg:flex-row gap-10 pt-16">
          <div className="w-full lg:w-1/2">
            <section className="border-l-4 border-l-orange-800 pl-4">
              <h3 className="text-3xl font-semibold mb-6">Education</h3>
              {educationData.map((item) => (
                <motion.div
                  key={item.id}
                  className="w-full border-2 border-orange-800 rounded-lg p-5 mb-4 bg-amber-100 shadow-md"
        ...
        <section className="text-center mt-16 border-2 pl-2 pr-2 rounded-2xl border-orange-800">
